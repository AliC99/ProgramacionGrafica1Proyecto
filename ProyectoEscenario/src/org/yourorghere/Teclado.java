...
public class Teclado implements KeyListener {
    ...
    static float trasladaZ = Proyecto.largo / 2.3f;
    ...
    public static float trasladar1 = 0;
    ...
    public static void trasladarX(GL gl) {
        trasladar1 += 0.07f;
        gl.glTranslatef(trasladar1, 0, 0);
//        System.out.println(trasladar1);
    }
...
//        System.out.println("d "+rotarY);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_W) {
            validarGiro = false;
                if (trasladaZ<2.1f &&trasladaZ>-3.1f && trasladaX<6f) {
                    trasladaZ=trasladaZ;
